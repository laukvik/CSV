 ...
 */
public final class BigDecimalLessThanMatcher implements ValueMatcher<BigDecimal> {
     ...
     */
    public BigDecimalLessThanMatcher(final BigDecimalColumn bigDecimalColumn, final BigDecimal value) {
        super();
