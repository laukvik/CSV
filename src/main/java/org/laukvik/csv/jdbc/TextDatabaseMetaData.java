...
public class TextDatabaseMetaData implements DatabaseMetaData {
    ...
    /**
     * TODO - Denne maa fikses
     */
    public ResultSet getColumns(String catalog, String schemaPattern,
            String tableNamePattern, String columnNamePattern)
            throws SQLException {
        TextResultSet rs = new TextResultSet(new Data());
        return rs;
    }
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        return new TextResultSet(Manager.listTables(connection.home, catalog, schemaPattern, tableNamePattern, types));
    }
