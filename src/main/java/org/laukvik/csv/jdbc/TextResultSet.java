...
public class TextResultSet implements java.sql.ResultSet {
    ...
    public TextResultSet(ColumnData data) {
        this.data = data;
    }
    ...
    public int findColumn(String columnName) throws SQLException {
        return data.indexOf(new Column(columnName));
    }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new TextResultSetMetaData(data);
    }
    ...
    public Object getObject(String columnName) throws SQLException {
        return data.getValue(new Column(columnName), rowIndex);
    }
