 ...
 */
public final class UrlProtocolMatcher extends RowMatcher implements ValueMatcher<URL> {
     ...
     */
    public UrlProtocolMatcher(final UrlColumn urlColumn, final String... value) {
